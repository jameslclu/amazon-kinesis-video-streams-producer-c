...
int StreamSource_GetCurrentIndex() {
    return -1;
}
...
/*
int KVSProducer_SetAudioVideoStreamInfo() {
}
*/
int KVSProducer_Init() {
    ...
    createKinesisVideoStreamSync(mClientHandle, mpStreamInfo, &mStreamHandle);
    //STREAM_HANDLE localStreamHandle = INVALID_STREAM_HANDLE_VALUE;
    //gStreamSource->streamHandle = localStreamHandle;
    return 0;
}
