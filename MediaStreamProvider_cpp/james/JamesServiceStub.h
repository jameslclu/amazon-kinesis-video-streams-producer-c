#ifndef JamesServiceStub_H
#define JamesServiceStub_H
#include <string>
...
class JamesServiceStub : public IJamesServiceListener {

  public:
    JamesServiceStub(IJamesService* pService);

    virtual ~JamesServiceStub();
    ...
    virtual int onJamesServiceCallback(std::string const &str);
  private:
